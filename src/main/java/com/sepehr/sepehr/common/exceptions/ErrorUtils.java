package com.sepehr.sepehr.common.exceptions;
...
public class ErrorUtils {
    ...
    public boolean isSameErrorCode(com.sepehr.sepehr.common.exceptions.ErrorCodes errorCode, Throwable throwable) {
